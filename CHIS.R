# Below is combined code for all the exercises in the Case Study chapter of Data Camp's
# Data Visualization wtih ggplot2 (Part 2)
...
# Age histogram
ggplot(adult, aes(SRAGE_P)) + geom_histogram()


# BMI histogram
ggplot(adult, aes(BMI_P)) + geom_histogram()
...
# Perform chi.sq test (RBMI and SRAGE_P) to get the Pearson residuals
